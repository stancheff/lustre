...
#
# LB_EXT4_INODE_EOFBLOCKS
#
# kernel 5.6-rc4 commit 9e52484c713321e84e8834803a44ca0a001376d2
# ext4: remove EXT4_INODE_EOFBLOCKS flag
#
AC_DEFUN([LB_EXT4_INODE_EOFBLOCKS], [
tmp_flags="$EXTRA_KCFLAGS"
EXTRA_KCFLAGS="-Werror"
...
ext4_get_blocks_keep_size, [
	...
	int f = EXT4_INODE_EOFBLOCKS;
	(void)f;
],[
	AC_DEFINE(HAVE_LDISKFS_INODE_EOFBLOCKS, 1,
		[EXT4_INODE_EOFBLOCKS exists])
])
EXTRA_KCFLAGS="$tmp_flags"
]) # LB_EXT4_INODE_EOFBLOCKS
